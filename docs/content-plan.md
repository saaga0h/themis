...
## Tier 1 — Root-level docs

| File | Status | Description |
|------|--------|-------------|
| README.md | exists | Project overview, usage, and workflow |
| ARCHITECTURE.md | exists | Component inventory and system structure |

## Tier 2 — Subsystem docs
...
- `docs/subsystems/pipeline/README.md` — pipeline state machine (issue #7)
